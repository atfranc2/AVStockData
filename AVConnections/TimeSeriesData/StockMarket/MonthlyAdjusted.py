...
class MonthlyAdjusted(StockMarket):
    def __init__(self, api_key):
        super().__init__(api_key)
        self.setTimeSeriesName()

    def setTimeSeriesName(self):
        self.time_series_name = "Monthly Adjusted Time Series"

    def getMonthlyAdjusted(self, ticker, data_type = 'json'):
        params = {'function':'TIME_SERIES_MONTHLY_ADJUSTED', 'symbol':ticker, 'datatype':data_type, 'apikey':self.api_key}
