...
class WeeklyAdjusted(StockMarket):
    ...
    def setTimeSeriesName(self):
        self.time_series_name = "Weekly Adjusted Time Series"

    def getWeeklyAdjusted(self, ticker, data_type = 'json'):
        params = {'function':'TIME_SERIES_WEEKLY_ADJUSTED', 'symbol':ticker, 'datatype':data_type, 'apikey':self.api_key}
